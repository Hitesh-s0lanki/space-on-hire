...
const variants = {
    base: 'relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[150px] max-h-[200px] min-w-full border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out',
    image:
        'border-0 p-0 w-full h-full relative shadow-md bg-slate-200 dark:bg-slate-900 rounded-md min-w-[200px]',
    active: 'border-2',
    disabled:
    ...
    (
        ...
        return (
            <div className=' w-full'>
                <div className={cn("grid grid-cols-2 gap-2", (!value || value.length === 0) && " grid-cols-1 w-full")}>
                    {/* Images */}
